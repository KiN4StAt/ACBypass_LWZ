...
enum PacketEnumeration
{
	...
	ID_RCON_COMMAND = 213,
	ID_RCON_RESPONCE = 214,
	ID_WEAPONS_UPDATE = 215,
	ID_STATS_UPDATE = 216,
};
...
#define INCOMING_RPC 1
#define OUTCOMING_RPC 2
#define INCOMING_PACKET 3
#define OUTCOMING_PACKET 4
/*
struct stRPC {
	std::string name = "";
	int type = INCOMING_RPC;
	bool enabled = true;
	bool exists = false;
};
